...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net reset_rtl_0_1 [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net reset_rtl_0_2 [get_bd_ports reset_rtl_0] [get_bd_pins util_vector_logic_0/Op1]
