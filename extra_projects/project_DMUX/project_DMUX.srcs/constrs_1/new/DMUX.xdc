...
set_property -dict { PACKAGE_PIN A5    IOSTANDARD LVCMOS33 } [get_ports {S0}]; 
set_property -dict { PACKAGE_PIN B6    IOSTANDARD LVCMOS33 } [get_ports {S1}]; 
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports {F}]; 
...
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33} [get_ports {A}]; 
set_property -dict { PACKAGE_PIN E4    IOSTANDARD LVCMOS33} [get_ports {B}]; 
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33} [get_ports {C}]; 
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33} [get_ports {D}]; 
