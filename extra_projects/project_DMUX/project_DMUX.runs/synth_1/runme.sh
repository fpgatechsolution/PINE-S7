...
HD_PWD='/home/admin1/Documents/projects/PINE_S7_details/basic_project/project_DMUX/project_DMUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1to4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_1to4.tcl
